...
const playerClass = require('../class.js')
...
module.exports = async function (id) {
    var newPromise = new Promise(function(resolve, reject) {
       var url = `https://roblox.com/users/${id}/profile`
        fetch(url, {headers:{'Cookie' : `.ROBLOSECURITY=${process.env.Cookie}`}}).then((res)=>{
            ...
            try {
                ...
                var previousNames = $('div[data-previoususernames]').attr('data-previoususernames').split('\n');
                ...
                if (previousNames[0]=='' || previousNames[0] == null) previousNames = [];
                var makeReturn = {
                    Status : userStatus,
                    Blurb : userBlurb,
                    Username : userName,
